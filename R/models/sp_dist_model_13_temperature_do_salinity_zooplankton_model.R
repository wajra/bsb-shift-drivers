...
# R code - Model runs - Model 13 - T+O+S+Z model
...
runname <- "zplk_salinity_dissolved_oxygen_with_only_sbt_2021_11_11"
...
for(i in 1:length(allspp)){  
  ...
  if(length(levels(spdata$regionfact))==1){
    ...
    mypresmod<-formula(presfit ~ s(SBT.seasonal) +  s(o2_seasonal) + s(zplk_class_sum_across_column) + s(salinity_seasonal) + s(rugosity) + s(GRAINSIZE))
    'Abundance model - If there is only one region'
    myabunmod<-formula(logwtcpue.pad ~ s(SBT.seasonal) +  s(o2_seasonal) + s(zplk_class_sum_across_column) + s(salinity_seasonal) + s(rugosity) + s(GRAINSIZE))
    ...
    mypresmod<-formula(presfit ~ s(SBT.seasonal) +  s(o2_seasonal) + s(zplk_class_sum_across_column) + s(salinity_seasonal) + s(rugosity) + s(GRAINSIZE) + regionfact)
    myabunmod<-formula(logwtcpue.pad ~ s(SBT.seasonal) +  s(o2_seasonal) + s(zplk_class_sum_across_column) + s(salinity_seasonal) + s(rugosity) + s(GRAINSIZE) + regionfact)
  ...
  if(length(abc[abc$reg.pres==TRUE,])==1){
    ...
    mypresmodtt<-formula(presfit ~ s(SBT.seasonal) +  s(o2_seasonal) + s(zplk_class_sum_across_column) + s(salinity_seasonal) + s(rugosity) + s(GRAINSIZE))
    myabunmodtt<-formula(logwtcpue.pad ~ s(SBT.seasonal) +  s(o2_seasonal) + s(zplk_class_sum_across_column) + s(salinity_seasonal) + s(rugosity) + s(GRAINSIZE))
  } else {
    mypresmodtt<-formula(presfit ~ s(SBT.seasonal) +  s(o2_seasonal) + s(zplk_class_sum_across_column) + s(salinity_seasonal) + s(rugosity) + s(GRAINSIZE) + regionfact)
    myabunmodtt<-formula(logwtcpue.pad ~ s(SBT.seasonal) +  s(o2_seasonal) + s(zplk_class_sum_across_column) + s(salinity_seasonal) + s(rugosity) + s(GRAINSIZE) + regionfact)
  }
